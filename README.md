A fork of https://github.com/magnific0/wondershaper that adds support to lowering the bandwidth to minimum in order to simulate network connectivity problems.
--------------
